...
<head>
  ...
  <title>Minhas Informações - Entre Linhas</title>
  <style>
    * {
      margin: 0;
      padding: 0;
    ...
    <div class="perfil-container">
      <div class="perfil-lateral">
        ...
        <div class="btn-container">
            ...
            <a href="editar_informacoes.php" class="btn-normie">
          ...
          <div class="info-container">
            <div class="info-group">
              ...
              <div class="info-linha">
                <strong>Email:</strong>
                <span><?php echo htmlspecialchars($vendedor_db['email']); ?></span>
              </div>
              ...
              <div class="info-linha">
                ...
                <span><?php echo htmlspecialchars($vendedor_db['telefone'] ?? ''); ?></span>
              </div>
              ...
              <div class="info-linha">
                <strong>CPF:</strong>
                <input type="text" name="cpf" id="cpf" value="<?= htmlspecialchars($vendedor_db['cpf'] ?? '') ?>" readonly>
              </div>
            ...
            <div class="info-group">
              ...
              <div class="info-linha">
                <strong>CEP</strong>
                <input type="text" name="cep" id="cep" value="<?= htmlspecialchars($vendedor_db['cep'] ?? '') ?>" readonly class="empty-field">
              </div>

              <div class="info-linha">
                <strong>Estado</strong>
                <input type="text" name="estado" id="estado" value="<?= htmlspecialchars($vendedor_db['estado'] ?? '') ?>" readonly class="empty-field">
              </div>

              <div class="info-linha">
                <strong>Cidade</strong>
                <input type="text" name="cidade" id="cidade" value="<?= htmlspecialchars($vendedor_db['cidade'] ?? '') ?>" readonly class="empty-field">
              </div>

              <div class="info-linha">
                <strong>Bairro</strong>
                <input type="text" name="bairro" id="bairro" value="<?= htmlspecialchars($vendedor_db['bairro'] ?? '') ?>" readonly class="empty-field">
              </div>

              <div class="info-linha">
                <strong>Rua</strong>
                <input type="text" name="rua" id="rua" value="<?= htmlspecialchars($vendedor_db['rua'] ?? '') ?>" readonly class="empty-field">
              </div>

              <div class="info-linha">
                <strong>Número</strong>
                <input type="text" name="numero" id="numero" value="<?= htmlspecialchars($vendedor_db['numero'] ?? '') ?>" readonly class="empty-field">
              </div>
            </div>
          </div>
      </div>
