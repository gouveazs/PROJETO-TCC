...
<body>
  <div class="perfil-container">
    ...
    <div class="info-container">
      ...
      <div class="info-linha">
        <strong>Senha:</strong>
        <input type="password" id="senhaInput" value="<?php echo htmlspecialchars($vendedor_db['senha']); ?>" readonly>
      </div>

      <div class="info-linha">
        <strong>CPF:</strong>
        <span><?php echo htmlspecialchars($vendedor_db['cpf']); ?></span>
      </div>
      ...
      <div class="info-linha">
        ...
        <span><?php echo htmlspecialchars($vendedor_db['data_nascimento']); ?></span>
      </div>
    </div>
    ...
    <div class="btn-container">
      ...
      <a href="painel_livreiro.php" class="btn-normie">
        ⬅ Voltar ao Início
      </a>
    </div>
  </div>
