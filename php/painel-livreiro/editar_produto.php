...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $paginas_faltando = $_POST['paginas_faltando'] ?? null;
    $folhas_amareladas = $_POST['folhas_amareladas'] ?? null;
    $paginas_rasgadas = $_POST['paginas_rasgadas'] ?? null;
    $anotacoes = $_POST['anotacoes'] ?? null;
    $lombada_danificada = $_POST['lombada_danificada'] ?? null;
    $capa_danificada = $_POST['capa_danificada'] ?? null;
  ...
  <div class="content-area">
    <main class="conteudo">
        ...
        <div class="form-group">
            ...
            <input type="text" name="autor" value="<?= htmlspecialchars($produto['autor']) ?>" required>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" name="editora" value="<?= htmlspecialchars($produto['editora']) ?>" required>
        </div>

        <div class="form-group">
            <label for="numero_paginas">Número de páginas:</label>
            <input type="number" name="numero_paginas" value="<?= $produto['numero_paginas'] ?>" required>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="date" name="data_publicacao" value="<?= $produto['data_publicacao'] ?>" required>
        </div>

        <div class="form-group">
            <label for="idioma">Idioma:</label>
            <input type="text" name="idioma" value="<?= htmlspecialchars($produto['idioma']) ?>" required>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="number" id="preco" name="preco" step="0.01" min="0" value="<?= htmlspecialchars($produto['preco']) ?>" readonly>
        </div>
        ...
        <div class="form-group">
            ...
            <input type="text" id="isbn" name="isbn" value="<?= htmlspecialchars($produto['isbn']) ?>" required>
        </div>

        <div class="form-group">
            <label for="dimensoes">Dimensões:</label>
            <input type="text" id="dimensoes" name="dimensoes" value="<?= htmlspecialchars($produto['dimensoes']) ?>" required>
        </div>
